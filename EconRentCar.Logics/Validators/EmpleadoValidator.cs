...
{
    class EmpleadoValidator: AbstractValidator<Empleado>
    {
        private static EmpleadoValidator instance;
        public static EmpleadoValidator Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = new EmpleadoValidator();
                }
                return instance;
            }
        }
