...
{
    public partial class MarcaMaster : EntityBaseMasterForm<Marca, MarcaDetail>
    {
        public MarcaMaster() : base(MarcaRepository.Instance, "")
        {
            InitializeComponent();
            Dtgv = dataGridView1;
        ...
        private void MarcaMaster_Load(object sender, EventArgs e)
        {
            FillDtgv();
        }
